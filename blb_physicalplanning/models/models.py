...
class blb_physicalplanning(models.Model):
    ...
    file_no = fields.Many2one('blb_client.blb_client', string='Client', required=True, readonly=True, ondelete='cascade')
    ...
    processed_by = fields.Many2one('res.users', string='Processed by', store=True, readonly=True, ondelete='cascade')
...
class consent_requests(models.Model):
    ...
    done_by = fields.Many2one('res.users', string='Done by', store=True, readonly=True, ondelete='cascade')
